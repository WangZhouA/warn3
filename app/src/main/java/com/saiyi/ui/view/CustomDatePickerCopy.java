 ...
 */
public class CustomDatePickerCopy {
    ...
    public CustomDatePickerCopy(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.custom_date_picker_copy);
    ...
    public void show(String time) {
        if (time.contains("null")) {
            time=TimeUtil.getCurrentAllTimeNowMiao();
            if (canAccess) {
